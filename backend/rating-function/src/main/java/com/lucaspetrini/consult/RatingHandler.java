 ...
 */
public class RatingHandler implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
	private static final Logger LOGGER = LoggerFactory.getLogger(RatingHandler.class);
	 ...
	 * @param requestModelClass request model class type.
	 */
